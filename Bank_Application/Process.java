...
public class Process {
    ...
    BankInfo bank1 = new BankInfo(); // Remove 'static' keyword

    public Process() { // Constructor
        bank1.setAccno("854621348597");
        bank1.setName("RBL Bank");
        bank1.setAcc_type("Saving"); // Fix method name
    ...
    public void deposite() {
        ...
        long amount = (bank1.getBalance()) + deposit;
